...
The parameters set up in Payrolls are the defaults applied to all employees assigned to that payroll.  The Pay Frequency and integration to the General Ledger and other D365 Business Central granules is defined and activated.
...
1.  To access the Payroll Card, go to the following menu: *General Setup/Payrolls*
...
3.  Double click on the record if you wish to edit this Payroll, Click **Periods** Button on the *Process* menu if you wish to view/edit the Pay Periods associated to this Payroll. 
...
13.  Click on the “Periods" Button on the *Process* menu, if you wish to view/edit the Pay Periods associated to this Payroll.
...
1.  You can access the Pay Periods window, by clicking on the “Periods” Button on the *Process* menu.
...
2.  Click on the "Navigate" menu if you wish to;
